...
I'm putting notes into `notes`. These can merged more easily, don't worry about editing the same files as I do, just push your changes OFTEN. I'm using Obsidian but Markdown is readable using normal text editors or GitHub.
